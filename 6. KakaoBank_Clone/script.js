...
const flyingRyanImage = document.getElementById("flying-ryan-image");
...
window.addEventListener("scroll", () => {
  ...
  if (
    ...
    flyingRyanImage.style.transform = `translate(${translateX}px, ${translateY}px) rotate(${rotationDegree}deg)`;
  }
